/**
 * Mixture Grid that moves around
...
//[pop matrix //graphics 
void defineLights() {
  // pink colour  point light on the right
  pointLight(245,22, 141,   // Color
             200, -150, 0); // Position

  // Blue colour  directional light from the left
...
//add some sort of feature so it wont be boring
//
